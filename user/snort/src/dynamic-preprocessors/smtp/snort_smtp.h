...
{
    BEGIN         = 0x0000,            /*  SMTP message has not started yet         */
    COMMAND       = 0x0001,            /*  Command section of SMTP message          */
    DATA          = 0x0002,            /*  DATA section header or body              */
    DATA_PEND     = 0x0004,            /*  DATA section, pending reply by server    */
    DATA_BODY     = 0x0008,            /*  DATA body section                        */
    MIME_HEADER   = 0x0010,            /*  MIME header section within DATA section  */
    TLS_DATA      = 0x0020             /*  Successful handshake, TLS encrypted data */
