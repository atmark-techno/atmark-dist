...
extern MagickExport void
  ...
  *GetLastValueInLinkedList(const LinkedListInfo *),
  *GetNextKeyInHashmap(HashmapInfo *),
  *GetNextValueInHashmap(HashmapInfo *),
  *GetNextValueInLinkedList(LinkedListInfo *),
  *GetValueFromHashmap(const HashmapInfo *,const void *),
  *GetValueFromLinkedList(const LinkedListInfo *,const unsigned long),
