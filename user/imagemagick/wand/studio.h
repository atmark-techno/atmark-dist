/*
  ...
  ImageMagick private application programming interface declarations.
*/
#ifndef _WAND_STUDIO_H
#define _WAND_STUDIO_H
...
#if !defined(_WAND_CONFIG_H)
# define _WAND_CONFIG_H
