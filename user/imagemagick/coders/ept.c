...
ModuleExport void RegisterEPTImage(void)
{
  ...
  entry->description=AcquireString("Encapsulated PostScript with TIFF preview");
  ...
  entry->blob_support=MagickFalse;
  entry->description=
    AcquireString("Encapsulated PostScript Level II with TIFF preview");
  entry->module=AcquireString("EPT");
  (void) RegisterMagickInfo(entry);
  ...
  entry->blob_support=MagickFalse;
  entry->description=
    AcquireString("Encapsulated PostScript Level III with TIFF preview");
  entry->module=AcquireString("EPT");
  (void) RegisterMagickInfo(entry);
}

