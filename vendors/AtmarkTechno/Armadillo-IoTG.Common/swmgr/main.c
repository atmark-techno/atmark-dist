...
#define GPIO_KEYS_POLLED_NAME	"gpio-keys-polled"
...
struct _sw sw[] = {
	{"sw1", KEY_1, "SW1 on Base board", GPIO_KEYS_NAME},
	{"sw2", KEY_2, "SW2 on Base board", GPIO_KEYS_POLLED_NAME},
	{"sw3", KEY_3, "SW3 on Base board", GPIO_KEYS_POLLED_NAME},
};

static 	unsigned int sw_index;
