...
char *__pthread_initial_thread_tos;
...
# ifdef _STACK_GROWS_UP
  ...
  __pthread_initial_thread_tos = __pthread_initial_thread_bos + 2 * STACK_SIZE;
# else
  ...
  __pthread_initial_thread_tos = (char *)(((long) CURRENT_STACK_FRAME | (STACK_SIZE - 1)) + 1);
# endif
#endif
